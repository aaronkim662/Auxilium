...
const Register = (props) => {
    ...
    <div className='registerStudent' >
        <form className='registerForm' onSubmit={props.makeStudent}>
            ...
            <input className='registerInput' type='password' placeholder='password' name="password" value={props.registerStudent.password} onChange={props.registerHandleChangeStudent}/>
    ...
    <div className='registerTeacher' >
        <form className='registerForm' onSubmit={props.makeTeacher}>
            ...
            <input className='registerInput' type='password' placeholder='password' name="password" value={props.registerTeacher.password} onChange={props.registerHandleChangeTeacher}/>
            <button className='registerButton'>Register</button>
        </form> 
        <h2>Already a user?</h2>
        <Link to='/login' >
